...
/* Cheapino thumb override: SPC/ENT on inner (easiest) positions */
#undef LAYER_CK_3x5_3
#define LAYER_CK_3x5_3 \
    KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,      KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, \
    KC_A,    KC_R,    KC_S,    KC_T,    KC_G,      KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    \
    KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,      KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, \
                  MO(_NAV), KC_SPC,  KC_BSPC,   C(KC_A), KC_ENT,   MO(_SYM)

#undef LAYER_NAV_3x5_3
...
#define LAYER_SYM_3x5_3 \
    ...
    KC_NO,   S(KC_LBRC),KC_GRV,S(KC_RBRC),KC_NO,   KC_NO,   KC_NUBS, KC_NO,   KC_SLSH, KC_NO,  \
                  KC_NO, C(KC_BSPC), KC_DEL,    KC_NO,   KC_NO,   KC_TRNS

#undef LAYER_FN_3x5_3
...
const uint16_t PROGMEM tmux[]    = {MO(_SYM), KC_ENT,   COMBO_END};
